...
function NavBar(){
    return (
        ...
        <div className="h-16 mx-auto px-5 flex items-center justify-between">
             <a className="text-2xl hover:text-cyan-500 transition-colors cursor-pointer "><img src='../img/logoBlack3.png' className='h-16' alt='logo consisiting of an @ sign looking like a dream catcher with { as the feathers with my initials'/></a> 
