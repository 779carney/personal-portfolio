  ...
  return (
    ...
    <div id="contact-me" className="flex mt-10 items-center justify-start bg-white ">
      <div className="mx-auto w-full max-w-lg mt-16">
        ...
        { isSuccessfull ?  <div>
          <p className="mt-10 mb-10 peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm">Thank you for your message, I will contact you shortly</p>
        </div> : null}
        { !validMessage ?  <div>
          <p className="mt-10 mb-10 peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm">Please fill in the input fields correctly</p>
        </div> : null}
      </div>
    </div>
        )
