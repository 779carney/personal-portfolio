  ...
  return (
    ...
    <div id="contact-me" className="flex mt-10 items-center justify-start bg-white ">
      <div className="mx-auto w-full max-w-lg mt-16">
        ...
        <form  name="contact"  onSubmit={handleSubmit}  className="mt-10"  data-netlify="true" >
        <input type="hidden" name="form-name" value="contact" />
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="relative z-0">
              <input type="text" id="fullName"  name="fullName"className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " required value={formName} onChange={(event) => {
            ...
            <div className="relative z-0">
              <input type="email" id="email" name="email"className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " required value={email} onChange={(event) => {
            ...
            <div className="relative z-0 col-span-2">
              <textarea name="message" id= 'message' rows="5" className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " required value={message} onChange={(event) => {
